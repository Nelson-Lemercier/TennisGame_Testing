...
// "player2 wins"
			...
			if (player1Points >= 3 && player1Points == player2Points) // Bug here : player1Points >= 4 --> player1Points >= 3
				return "deuce";
			
			if (player1Points >= 4 && player1Points - player2Points == 1)
				return "player1 has advantage";
			
			if (player2Points >= 4 && player2Points - player1Points == 1) // Bug here : player2Points > 4 --> player2Points >= 4
				return "player2 has advantage";							
			
			return  player2Score + " - " + player1Score ; //Maybe not a bug but not logical ...
	}
}